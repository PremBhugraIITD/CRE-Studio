...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white text-black-100 flex flex-col items-center justify-center">
      ...
      <div className="w-[200px] h-[2px] bg-white-800 rounded relative overflow-hidden">
        <div className="w-[40%] h-full bg-black shadow-[0_0_15px_#3b82f6] animate-loading-bar"></div>
      </div>
    </div>
  );
};
